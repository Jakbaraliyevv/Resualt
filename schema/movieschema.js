...
const movieSchema = new Schema(
  {
    title: { type: String, required: true }, // Film nomi
    ageRestriction: { type: Number, required: true }, // Yosh cheklovi
    image: { type: String, required: true }, // Rasm URL manzili
    targetAudience: { type: String, required: true }, // Auditoriya
    genre: { type: [String], required: true }, // Janrlar ro'yxati
    availableDate: { type: String, required: true }, // Mavjud sanasi
    availableTime: { type: String }, // Vaqt
    format: { type: String, required: true }, // Format: "2D", "3D", "4D"
    ...
    year: { type: Number, required: true }, // Yil
    description: { type: String, required: true }, // Qisqacha ma'lumot
    count: { type: Number, required: true, default: 100 }, // Chiptalar soni
  },
  { versionKey: false } // `_v` ni olib tashlash
);
